 ...
 * than a stan-alone one. But that could make the bytecode a bit more complex.
 */
public class FunctionBrain {
  /**
   * Called in each azure function entry point for each function invocation. Makes sure that quarkus
   * is initialized and the actual user function is available from the CDI container.
   *
